...
#define DELAY_1_MILLISECOND							(1)
#define DELAY_1_SECOND								(1000 * DELAY_1_MILLISECOND)
...
#define GET_PCNT_OF_VAL(pcnt, val)					((s32)((float)(val) * (float)(pcnt > 100 ? 100 : pcnt) / 100.0))
...
#define ASSIGN_NOT_NULL_VAL_TO_PTR(ptr, new_val)	do {if(new_val != NULL) ptr = new_val;} while(0)
