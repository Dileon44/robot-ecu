...
#ifdef WSH_FW_PLATFORM_M4
#ifdef WSH_FW_PLATFORM_C0
#define configTOTAL_HEAP_SIZE						((size_t)0x20000)
#endif /* WSH_FW_PLATFORM_C0 */
#ifdef WSH_FW_PLATFORM_C1
#define configTOTAL_HEAP_SIZE						((size_t)0x100000)
#endif /* WSH_FW_PLATFORM_C1 */
#else
...
void FreeRTOS_ErrorHandler(char *file, int line);

#define	FREERTOS_PANIC()							FreeRTOS_ErrorHandler(__FILE__, __LINE__);
